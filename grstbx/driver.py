...
class l2grs():
    ...
    def get_l2a_datacube(self, subset=None, reproject=False, epsg_out=3857):
        ...
        for file in self.files:
            ...
            Npix_valid = product['Rrs'].isel(wl=1).count().compute()
            product['valid_pix_prop'] = Npix_valid / Npix_tot
            if product['valid_pix_prop'] == 0:
                continue
            product['valid_pix_prop'].attrs['description'] = 'Proportion of valid pixels within the image raster'
